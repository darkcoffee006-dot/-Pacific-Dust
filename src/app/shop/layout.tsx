...
export const metadata: Metadata = {
  ...
  description:
    "Buy premium 240 GSM oversized graphic tees online from Pacific Dust. City of Angels, Dreams, Unbothered & Gradient Soul. Made in Delhi NCR. Free delivery above Rs. 1000. Sizes S, M, L, XL.",
  alternates: { canonical: "https://pacificdust.co.in/shop" },
  openGraph: {
    title: "Pacific Dust Shop — Buy Oversized T-Shirts Online India",
    description:
      "240 GSM French Terry oversized graphic tees. City of Angels, Dreams, Unbothered & Gradient Soul. Pan-India delivery. Free shipping above Rs. 1000.",
