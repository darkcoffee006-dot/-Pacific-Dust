  ...
  return (
    <main>
      <section className="pt-40 pb-16 px-6 md:px-10 border-b border-line">
        ...
        <h1 className="font-display text-6xl md:text-[10rem] mt-8 leading-[0.88]">
          Ideas behind<br /><em className="italic font-light">the cloth.</em>
        </h1>
      </section>
      ...
      <section className="grid md:grid-cols-12 gap-10 px-6 md:px-10 py-24 border-b border-line">
        <div className="md:col-span-7 relative aspect-[16/10]">
          <Image
            src="/images/pacific/black/city of angels/DSCN5554.JPG.jpg.jpeg"
            alt="City of Angels Tee — Pacific Dust Drop 01"
            fill
        ...
        <article className="md:col-span-5 flex flex-col justify-end">
          ...
          <h2 className="font-display text-4xl md:text-6xl mt-4 leading-[0.98]">
            The mindset behind Pacific Dust.
          </h2>
          <p className="mt-6 text-ink-muted leading-relaxed">
            What it means to refuse to settle — why we spent a year rebuilding before our first drop,
            and why every piece has to earn its place in the lineup.
          </p>
      ...
      <section className="bg-surface py-32 px-6 md:px-10 text-center">
        ...
        <p className="font-display text-4xl md:text-6xl mt-6 max-w-3xl mx-auto leading-tight">
          Drop alerts and stories — straight to your inbox.
        </p>
        <form className="mt-10 max-w-md mx-auto flex border-b border-ink pb-2">
          ...
          />
          <button type="submit" className="text-[11px] uppercase tracking-[0.22em]">
            Subscribe →
          </button>
        </form>
      </section>
